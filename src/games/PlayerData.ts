...
class PlayerData {
    ...
    init() {
        ...
        this.fireData = Laya.loader.getRes("res/config/fire.json")
        this.bossData = Laya.loader.getRes("res/config/bossdata.json")
        
        //关卡
        // this.levelData = Laya.loader.getRes("res/config/level.json");
        // this.turnplateData = Laya.loader.getRes("res/config/turnplate.json")
